#define TRP_DEFAULT_MATCH_METHOD_RETURN 1
#define TRP_DEFAULT_MATCH_METHOD_ARGS   1
#define TRP_DEFAULT_MATCH_METHOD_CV     1
...
void check_relaxed_impl() {
    ...
    test::expect_eq(case_name, "relaxed impl", ref.value(reqtest::short_arg), int{relaxed_result});
}
...
void check_match_return_impl() {
    ...
    test::expect_eq(case_name, "match return impl", ref.value(reqtest::short_arg), match_result);
}
...
void check_exact_impl() {
    ...
    test::expect_eq(case_name, "exact impl", ref.value(reqtest::short_arg), exact_result);
}
...
void check_exact_cv_impl() {
    ...
    test::expect_eq(case_name, "exact cv impl", ref.value(reqtest::short_arg), exact_cv_result);
}
...
void check_non_additive_overrides() {
    ...
    test::expect_eq(case_name, "method-level override", ref.value(reqtest::short_arg), exact_result);
}
