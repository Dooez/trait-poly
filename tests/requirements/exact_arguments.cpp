...
static_assert(trp::implements_trait<extra_eop_default_impl, exact_eop_trait>);
...
int main() {
    ...
    auto eop_ref  = trp::dyn_trait_ref<exact_eop_trait>(eop_impl);
